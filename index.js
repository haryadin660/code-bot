...
const wa = 'https://chat.whatsapp.com/CvJWE2KILuLCE5m4r4xkvJ'; // LINK GRUP WA JANGAN DIGANTI YA BIAR KUMPUL DISITU SALING MENGENAL:)
const ow = 'HARYADIN'; // GANTI PAKE NAMA MU
const nomorowner = '082279601471'; // GANTI PAKE NOMOR MU ( JANGAN NOMOR BOT )
const ovo = '0858-9618-1301'; // GANTI PAKE NOMOR OVO LU
...
conn.sendMessage(id, '*Waalaikumsalam, Ada yang bisa saya bantu? kalo bingung ketik !menu ya kak🤗...*' ,MessageType.text);
 ...
 if (text == 'p'){
conn.sendMessage(id, '*Ya?, ada yang bisa saya bantu? kalo bingung ketik !menu ya kak...*' ,MessageType.text);
}
 if (text == 'P'){
conn.sendMessage(id, '*Ya?, ada yang bisa saya bantu? kalo bingung ketik !menu ya kak...*' ,MessageType.text);
}
...
conn.sendMessage(id, '*Hallo kak, Ada yang bisa saya bantu? kalo bingung ketik !menu ya kak🤗...*' ,MessageType.text);
 ...
 if (text == 'Asu'){
conn.sendMessage(id, '*Lu Asw _-*' ,MessageType.text);
}
 if (text == 'Haryadin'){
...
conn.sendMessage(id, '*Hai juga, Ada yang bisa saya bantu? kalo bingung ketik !menu ya kak🤗...*' ,MessageType.text);
 ...
 if (text == 'Woi'){
conn.sendMessage(id, '*Ya?, ada yang bisa saya bantu? kalo bingung ketik !menu ya....*' ,MessageType.text);
} 
 if (text == 'Hi'){
...
conn.sendMessage(id, '*Ya?, ada yang bisa saya bantu? kalo bingung ketik !menu ya um...*' ,MessageType.text);
 ...
 if (text == 'Anjir'){
conn.sendMessage(id, '*JAGA,  UCAPAN SAYANG:)*' ,MessageType.text);
}
 if (text == 'anjir'){
conn.sendMessage(id, '*JAGA,  UCAPAN SAYANG:)*' ,MessageType.text);
}
...
if (text == '.-.'){
conn.sendMessage(id, '*Tolong ya para member grup jangan spam kasih jeda dikit ngapa:(*' ,MessageType.text);
}
if (text == 'Kontol'){
conn.sendMessage(id, '*Astagfirullah, tobat ngab_-*' ,MessageType.text);
}
if (text == 'Memek'){
conn.sendMessage(id, '*Astagfirullah, tobat ngab_-*' ,MessageType.text);
}
...
if (text == 'Felix'){
conn.sendMessage(id, '*Itu Admin paling ganteng*' ,MessageType.text);
}
if (text == 'Owner goblok'){
conn.sendMessage(id, '*Bacot lu, brani brani nya hina ownerku*' ,MessageType.text);
}
...
/*INFO ANIME
  if (text.includes("!infoanime")) {
    ...
    axios.get(`https://arugaz.herokuapp.com/api/kuso?q=${sons}`).then((res) => {
      conn.sendMessage(id, '*Bentar kak gue cari dulu ya kan...*', MessageType.text, { quoted: m })
  ...
  if (text.includes("!tebakgambar")) {
    axios.get(`https://api.vhtear.com/tebakgambar&apikey=${apivhtear}`).then((res) => {
      imageToBase64(res.data.result.soalImg)
        .then(
          (ress) => {
            conn.sendMessage(id, '*sabar kak, gak bisa jawab donasi ya🤣*', MessageType.text, { quoted: m })
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, buf, MessageType.image, { quoted: m })
          })
    })
    ...
    axios.get(`https://api.vhtear.com/ytdl?link=${teks}&apikey=${apivhtear}`).then((res) => {
      imageToBase64(res.data.result.imgUrl)
        .then(
          (ress) => {
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, '*[❗] Sabar dulu ya.....*', MessageType.text, { quoted: m })
...
//TWITER DOWNLOAD
  if (text.includes('!twitdl')) {
    ...
    axios.get(`https://mhankbarbar.tech/api/twit?url=${teks}&apiKey=${apibarbar}`).then((res) => {
      conn.sendMessage(id, '*[ WAIT ] Sabar dulu ya.....*', MessageType.text, { quoted: m })
...
//IG DOWNLOAD
  if (text.includes('!ig')) {
    ...
    axios.get(`https://mhankbarbar.tech/api/ig?url=${teks}&apiKey=${apibarbar}`).then((res) => {
      conn.sendMessage(id, '*[ WAIT ] Sabar dulu yakan...*', MessageType.text, { quoted: m })
      let hasil = `Klik link dan download hasilnya!\n*Link* : ${res.data.result}`;
      conn.sendMessage(id, hasil, MessageType.text, { quoted: m });
    })
  }
        ...
        imageToBase64(cewek) // Path to the image
          .then(
            (response) => {
              ...
              conn.sendMessage(id, buf, MessageType.image, { caption: `*nih cuk...*`, quoted: m })
        ...
        imageToBase64(nimek)
          .then(
            (response) => {
              ...
              var buf = Buffer.from(response, 'base64');
              conn.sendMessage(id, buf, MessageType.image, { caption: `*wibu ya lu ya:v?*`, quoted: m })
            }
          )
          .catch(
            (error) => {
    ...
    axios.get(url)
      .then((result) => {
        ...
        imageToBase64(nimek)
          .then(
            (response) => {
              conn.sendMessage(id, '*Sabar um... orang sabar disayang janda:)*', MessageType.text, { quoted: m })
              var buf = Buffer.from(response, 'base64');
    ...
    axios.get(url)
      .then((result) => {
        ...
        imageToBase64(nimek)
          .then(
            (response) => {
              conn.sendMessage(id, '*Sabar om...orang sabar disayang janda:)*', MessageType.text, { quoted: m })
              var buf = Buffer.from(response, 'base64');
              conn.sendMessage(id, buf, MessageType.image, { caption: `*Nihh kak....* `, quoted: m })
            }
          )
          .catch(
            (error) => {
    ...
    axios.get(url)
      .then((result) => {
        ...
        imageToBase64(nimek)
          .then(
            (response) => {
              conn.sendMessage(id, '*WAIT sedang proses...*', MessageType.text, { quoted: m })
              var buf = Buffer.from(response, 'base64');
              conn.sendMessage(id, buf, MessageType.image, { quoted: m })
            }
          )
  ...
  var teks = text.replace(/!cersex /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result.image)
        .then(
          (ress) => {
            conn.sendMessage(id, '*[🌠] Tunggu Bentar ngab:v*', MessageType.text, {quoted : m} )
            var buf = Buffer.from(ress, 'base64')
  ...
  var url = "https://api.vhtear.com/hartatahta?text=" +teks+ "&apikey=" +apivhtear;
    ...
    .then((res) => {
      imageToBase64(url)
        .then(
          (ress) => {
            conn.sendMessage(id, '*[❗] Nih kak:v*', MessageType.text, {quoted : m} )
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, buf, MessageType.image)
        })
    })
  ...
  var url = "https://api.vhtear.com/glitchtext?text1="+atas+"&text2=" +bawah+"&apikey=" +vhtear;
    ...
    .then((res) => {
      imageToBase64(url)
        .then(
          (ress) => {
            conn.sendMessage(id, '*[❗] Bentar Om Sabar...*', MessageType.text, {quoted : m} )
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, buf, MessageType.image, {caption : '*Nih kak*'} )
        })
    })
}*/
//PUBG LOGO
    ...
    axios.get(`https://api.zeks.xyz/api/snowwrite?text1=${text1}&text2=${text2}&apikey=${vinzkey}`)
      .then((res) => {
        imageToBase64(res.data.result)
          .then(
            (ress) => {
              conn.sendMessage(id, '*[🔰] Bentar bro gw pergi ke salju nya dulu...*', MessageType.text, { quoted: m })
              var buf = Buffer.from(ress, 'base64')
